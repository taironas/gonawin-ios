...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$CONFIGURATION_BUILD_DIR/DateTools/DateTools.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/FontAwesomeKit/FontAwesomeKit.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/GonawinEngine/GonawinEngine.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/LVTwitterOAuthClient/LVTwitterOAuthClient.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/Locksmith/Locksmith.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/Moya/Moya.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/NSData+Base64/NSData_Base64.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/OAuthCore/OAuthCore.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/PageMenu/PageMenu.framework"
